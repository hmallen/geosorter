    ...
    <div className="desktop-content">
      ...
      {status && !closed && status.state !== 'closing' && !quitBusy && <>
        ...
        {settings && status.configured && <section className="desktop-section"><h2>Extras</h2>
          ...
          <div className="desktop-extra"><div><h3>Parks, peaks & lakes</h3><p>A larger place-name download for wilderness captures.</p></div><button disabled={disabled} onClick={() => action(() => start('features'))}>Download detailed places</button></div>
