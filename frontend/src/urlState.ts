...
// hash, query-style — `#map=<zoom>/<lat>/<lon>&place=...&cap=...&from=...&to=...&fav=1`
...
// (map, place, cap, from, to, fav) so equal states always produce equal hashes;
// precision: zoom 2 decimals, lat/lon 5 (~1 m).
